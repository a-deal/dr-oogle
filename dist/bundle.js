...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Reviews = __webpack_require__(218);

	var _Reviews2 = _interopRequireDefault(_Reviews);

	var _Review = __webpack_require__(220);

	var _Review2 = _interopRequireDefault(_Review);

	var _UrlInput = __webpack_require__(219);
	...
	_reactDom2.default.render(_react2.default.createElement(
		...
		_react2.default.createElement(
			...
			_react2.default.createElement(_reactRouter.Route, { path: '/onDemand', component: _UrlInput2.default }),
			_react2.default.createElement(
				_reactRouter.Route,
				{ path: '/reviews', component: _Reviews2.default },
				_react2.default.createElement(_reactRouter.Route, { path: '/reviews/:dentist', component: _Review2.default })
			)
		)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Reviews = function (_Component) {
		...
		function Reviews(props) {
			...
			_this.state = {
				dentists: ['dr deal', 'dr vinyoo', 'dr wilson', 'dr bothman']
			};
			return _this;
		}
			...
			value: function render() {
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						'h1',
						null,
						'This is where reviews are going'
					),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var UrlInput = function (_Component) {
		...
		function UrlInput() {
			...
			return _possibleConstructorReturn(this, Object.getPrototypeOf(UrlInput).apply(this, arguments));
		}

		_createClass(UrlInput, [{
			key: 'handleSubmit',
			value: function handleSubmit() {
				var oogleUrl = this.url.value;
				this.url.value = '';
			}
		}, {
			key: 'setRef',
			...
			value: function render() {
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement('input', { type: 'text', placeholder: 'Dr. Oogle URL', ref: function ref(_ref) {
